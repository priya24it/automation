...
db_details = c.load_tables_names(module="module2")
table_names = db_details["Tablenames"]
module2_details = c.load_snowflake_data()
process_date = module2_details["module2_stage_details"]["process_date"]
...
class Testmodule2:
    ...
    def _setup(self, cursor, tn):
        ...
        pytest.work_table = c.get_work_table_data(cursor, tn,module="module2")
        pytest.work_pk = c.get_work_table_pk(cursor, tn,module="module2")
        pytest.stage_table = c.get_stage_table_data(cursor, tn,module="module2")
        pytest.stage_pk = c.get_stage_table_pk(cursor, tn,module="module2")
